...
colornum         = 4
dpi              = 400
plot_fileu       = "hist_uy_streak_83pi_correct"
plot_filev       = "hist_vy_streak_83pi_correct"
plot_filew       = "hist_wy_streak_83pi_correct"
bins             = 100
lev_min          = 1e-3
lev_delta        = 7 #None
linewidth        = 3
...
wmin             = -4.5
wmax             = 4.5
saveh5           = "save_histogram_streak_correct.h5"
