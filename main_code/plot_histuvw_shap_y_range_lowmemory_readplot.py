...
colornum         = 4
dpi              = 400
plot_fileu       = "hist_uy_shap_83pi_correct_sketch"
plot_filev       = "hist_vy_shap_83pi_correct_sketch"
plot_filew       = "hist_wy_shap_83pi_correct_sketch"
bins             = 100
lev_min          = 1e-3
lev_delta        = 7 #None
linewidth        = 3
...
wmin             = -4.5
wmax             = 4.5
saveh5           = "save_histogram_shap_correct.h5"
