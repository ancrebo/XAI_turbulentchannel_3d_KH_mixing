...
def plotstruc3d_separe_trim(data_in={"struc":[],"plot_folder":"plots","xlabel":"$x^+$","ylabel":"$y^+$","zlabel":"z^+",
                                     "fontsize":18,"figsize_x":10,"figsize_y":8,"colormap":"viridis","colornum":2,
                                     "fig_name":"struc3d","dpi":60,"dy":1,"dx":1,"dz":1,"uvw_folder":"../../P125_21pi_vu/",
                                     "uvw_file":"P125_21pi_vu.$INDEX$.h5.uvw","L_x":2*np.pi,"L_y":1,"L_z":np.pi,
                                     "rey":125,"utau":0.060523258443963,"cmap_flag":False,"padtext":[0,0,0],"xtrim":[50,100],
                                     "ztrim":[50,100]}):
    """
    .....................................................................................................................
    # plotstruc3d_separe: Function to generate the plot of the 3d structures separated in 2 semichannels
    ...
    padtext_y   = padtext[1]
    padtext_z   = padtext[2]
    xtrim       = np.array(data_in["xtrim"])
    ztrim       = np.array(data_in["ztrim"])
    ...
    # -------------------------------------------------------------------------------------------------------------------
    mat_segment     = struc.structures.mat_segment_filtered
    mat_segment_low = mat_segment[:flow_data.yl_s,ztrim[0]:ztrim[1],xtrim[0]:xtrim[1]]
    mat_segment_upp = np.flip(mat_segment[flow_data.yu_s:,ztrim[0]:ztrim[1],xtrim[0]:xtrim[1]],0)
    index           = str(struc.index)
    ...
    plot_train = plot_format(data_in=data_plot)
    plot_train.create_figure3d()
    plot_info1 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,"data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_low,
                  "color":None,"cmap_flag":cmapflag,"vmax":None,"vmin":None}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
    plot_train.plot_layout_3d(data_in={"xticks":[flow_data.xplus[xtrim[0]],flow_data.xplus[xtrim[1]]],
                                       "yticks":[flow_data.zplus[ztrim[0]],flow_data.zplus[ztrim[1]]],
                                       "zticks":[0,L_y*rey],
                                       "xticklabels":[str(int(np.round(flow_data.xplus[xtrim[0]]))),
                                                      str(int(np.round(flow_data.xplus[xtrim[1]])))],
                                       "yticklabels":[str(int(np.round(flow_data.zplus[ztrim[0]]))),
                                                      str(int(np.round(flow_data.zplus[ztrim[1]])))],
                                       "zticklabels":["0",
                                                      str(int(np.round(L_y*rey)))],
                                       "L_x":flow_data.xplus[xtrim[1]]-flow_data.xplus[xtrim[0]],"L_y":L_y*flow_data.rey,
                                       "L_z":flow_data.zplus[ztrim[1]]-flow_data.zplus[ztrim[0]],"xpad":padtext_x,"ypad":padtext_y,
                                       "zpad":padtext_z})
    try:
        os.mkdir(plot_folder)
    except:
    ...
    plot_train = plot_format(data_in=data_plot)
    plot_train.create_figure3d()
    plot_info1 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,"data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_upp,
                  "color":None,"cmap_flag":cmapflag,"vmax":None,"vmin":None}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
    plot_train.plot_layout_3d(data_in={"xticks":[flow_data.xplus[xtrim[0]],flow_data.xplus[xtrim[1]]],
                                       "yticks":[flow_data.zplus[ztrim[0]],flow_data.zplus[ztrim[1]]],
...
def plotstruc3d_separe_coin_trim(data_in={"struc":[],"struc2":[],"plot_folder":"plots","xlabel":"$x^+$","ylabel":"$y^+$","zlabel":"z^+",
                                          "fontsize":18,"figsize_x":10,"figsize_y":8,"colormap":"viridis","colornum":2,
                                          "fig_name":"struc3d","dpi":60,"dy":1,"dx":1,"dz":1,"uvw_folder":"../../P125_21pi_vu/",
                                          "uvw_file":"P125_21pi_vu.$INDEX$.h5.uvw","L_x":2*np.pi,"L_y":1,"L_z":np.pi,
                                          "rey":125,"utau":0.060523258443963,"cmap_flag":False,"padtext":[0,0,0],"xtrim":[50,100],
    ...
    mat_segment_un                    = mat_segment.copy()
    mat_segment_un[mat_segment2 == 0] = 0
    mat_segment_di                    = mat_segment.copy()
    mat_segment_di[mat_segment2 > 0]  = 0
    mat_segment_low_un                = mat_segment_un[:flow_data.yl_s,ztrim[0]:ztrim[1],xtrim[0]:xtrim[1]]
    mat_segment_upp_un                = np.flip(mat_segment_un[flow_data.yu_s:,ztrim[0]:ztrim[1],xtrim[0]:xtrim[1]],0)
    mat_segment_low_di                = mat_segment_di[:flow_data.yl_s,ztrim[0]:ztrim[1],xtrim[0]:xtrim[1]]
    mat_segment_upp_di                = np.flip(mat_segment_di[flow_data.yu_s:,ztrim[0]:ztrim[1],xtrim[0]:xtrim[1]],0)
    index                             = str(struc.index)
    ...
    data_plot  = {"xlabel":xlabel,"ylabel":ylabel,"zlabel":zlabel,"fontsize":fontsize,"figsize_x":figsize_x,
                  "figsize_y":figsize_y,"xscale":"linear","yscale":"linear","zscale":"linear","colormap":colormap,
                  "colornum":colornum,"legend":False,"fig_name":fig_name+'_low'+"_field"+index+"union","dpi":dpi,
                  "plot_folder":plot_folder,"xmin":None,"xmax":None,"ymin":None,"ymax":None,"zmin":None,"zmax":None}
    plot_train = plot_format(data_in=data_plot)
    plot_train.create_figure3d()
    plot_info1 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,"data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_low_un,
                  "color":None,"cmap_flag":cmapflag,"vmax":None,"vmin":None}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
    plot_train.plot_layout_3d(data_in={"xticks":[flow_data.xplus[xtrim[0]],flow_data.xplus[xtrim[1]]],
                                       "yticks":[flow_data.zplus[ztrim[0]],flow_data.zplus[ztrim[1]]],
    ...
    data_plot  = {"xlabel":xlabel,"ylabel":ylabel,"zlabel":zlabel,"fontsize":fontsize,"figsize_x":figsize_x,
                  "figsize_y":figsize_y,"xscale":"linear","yscale":"linear","zscale":"linear","colormap":colormap,
                  "colornum":colornum,"legend":False,"fig_name":fig_name+'_upp'+"_field"+index+"union","dpi":dpi,
                  "plot_folder":plot_folder,"xmin":None,"xmax":None,"ymin":None,"ymax":None,"zmin":None,"zmax":None}
    plot_train = plot_format(data_in=data_plot)
    plot_train.create_figure3d()
    plot_info1 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,"data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_upp_un,
                  "color":None,"cmap_flag":cmapflag,"vmax":None,"vmin":None}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
    plot_train.plot_layout_3d(data_in={"xticks":[flow_data.xplus[xtrim[0]],flow_data.xplus[xtrim[1]]],
                                       "yticks":[flow_data.zplus[ztrim[0]],flow_data.zplus[ztrim[1]]],
    ...
    data_plot  = {"xlabel":xlabel,"ylabel":ylabel,"zlabel":zlabel,"fontsize":fontsize,"figsize_x":figsize_x,
                  "figsize_y":figsize_y,"xscale":"linear","yscale":"linear","zscale":"linear","colormap":colormap,
                  "colornum":colornum,"legend":False,"fig_name":fig_name+'_low'+"_field"+index+"difference","dpi":dpi,
                  "plot_folder":plot_folder,"xmin":None,"xmax":None,"ymin":None,"ymax":None,"zmin":None,"zmax":None}
    plot_train = plot_format(data_in=data_plot)
    plot_train.create_figure3d()
    plot_info1 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,"data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_low_di,
                  "color":None,"cmap_flag":cmapflag,"vmax":None,"vmin":None}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
    plot_train.plot_layout_3d(data_in={"xticks":[flow_data.xplus[xtrim[0]],flow_data.xplus[xtrim[1]]],
                                       "yticks":[flow_data.zplus[ztrim[0]],flow_data.zplus[ztrim[1]]],
    ...
    data_plot  = {"xlabel":xlabel,"ylabel":ylabel,"zlabel":zlabel,"fontsize":fontsize,"figsize_x":figsize_x,
                  "figsize_y":figsize_y,"xscale":"linear","yscale":"linear","zscale":"linear","colormap":colormap,
                  "colornum":colornum,"legend":False,"fig_name":fig_name+'_upp'+"_field"+index+"difference","dpi":dpi,
                  "plot_folder":plot_folder,"xmin":None,"xmax":None,"ymin":None,"ymax":None,"zmin":None,"zmax":None}
    plot_train = plot_format(data_in=data_plot)
    plot_train.create_figure3d()
    plot_info1 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,"data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_upp_di,
                  "color":None,"cmap_flag":cmapflag,"vmax":None,"vmin":None}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
    plot_train.plot_layout_3d(data_in={"xticks":[flow_data.xplus[xtrim[0]],flow_data.xplus[xtrim[1]]],
                                       "yticks":[flow_data.zplus[ztrim[0]],flow_data.zplus[ztrim[1]]],
