...
import os
from py_bin.py_plots.plotstruc3d import plotstruc3d_separe_trim, plotstruc3d_separe_coin_trim
import numpy as np
...
plotstruc3d_separe_trim(data_in={"struc":uv_struc,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,"zlabel":zlabel,
                                 ...
                                 "xtrim":[50,100],"ztrim":[50,100]})


plotstruc3d_separe_coin_trim(data_in={"struc":uv_struc,"struc2":shap_struc,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,"zlabel":zlabel,
                                 "fontsize":fontsize,"figsize_x":figsize_x,"figsize_y":figsize_y,"colormap":colormap,
                                 "colornum":colornum,"fig_name":fig_name,"dpi":dpi,"dy":dy,"dx":dx,"dz":dz,
                                 "uvw_folder":uvw_folder,"uvw_file":uvw_file,"L_x":L_x,"L_y":L_y,"L_z":L_z,
                                 "rey":rey,"utau":utau,"cmap_flag":True,"padtext":[padtext_x,padtext_y,padtext_z],
